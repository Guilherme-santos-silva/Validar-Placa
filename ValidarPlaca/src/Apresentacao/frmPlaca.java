...
public class frmPlaca extends javax.swing.JDialog
{
     ...
     */
    public frmPlaca(java.awt.Frame parent, boolean modal)
    {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents()
    {
        ...
        jLabel1.setText("Digite a placa do seu automovel:");

        btnPlaca.setText("Verificar Placa");
    ...
    {//GEN-HEADEREND:event_btnPlacaActionPerformed
       Modelo.Placa placa = new Placa();
       placa.Placa(txtPlaca.getText());
       JOptionPane.showMessageDialog(null, placa.getMensagem());
       txtPlaca.setText("");
    ...
    public static void main(String args[])
    {
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                frmPlaca dialog = new frmPlaca(new javax.swing.JFrame(), true);
